...
argparser = ArgumentParser(
    description="Generate MITRE ATT&CK(r) content for pySigma from ATT&CK STIX definition."
)
...
argparser.add_argument(
    ...
    type=str,
    default="12.1",
    help="Manually set the MITRE ATT&CK(r) version.",
)
argparser.add_argument(
    "stix", type=FileType("r"), nargs="+", help="Files with ATT&CK STIX definitions"
)
